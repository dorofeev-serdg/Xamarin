...
namespace iOS
{
	// This is the second version of controller which allows to autorotate application.
	// not yet completed
	public class CalcController : UIViewController 
	{
		...
		public override void LoadView ()
		{
			...
			case UIInterfaceOrientation.LandscapeRight:
				...
				NSBundle.MainBundle.LoadNib ("CalcLandView", this, null);

				//CalcLandView landView = new CalcLandView (){ Frame = View.Frame };
			...
			case UIInterfaceOrientation.PortraitUpsideDown:
				...
				NSBundle.MainBundle.LoadNib ("CalcPortView", this, null);

				//CalcPortView portView = new CalcPortView (){ Frame = View.Frame };
				//View.AddSubview (portView);
